...
BOOL Init(HWND hWnd)
{
	...
	// シェーダーをコンパイル
	{
		...
		if (FAILED(D3DCompileFromFile(L"VertexSharder.hlsl", nullptr, nullptr, "VSMain", "vs_5_0", compileFlags, 0, &vertexShader, nullptr))) return FALSE;
		if (FAILED(D3DCompileFromFile(L"PixelShader.hlsl", nullptr, nullptr, "PSMain", "ps_5_0", compileFlags, 0, &pixelShader, nullptr))) return FALSE;
